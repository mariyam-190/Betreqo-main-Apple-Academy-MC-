...
//
    ...
    struct Dictationa7: View {
        @State private var currentLine = Line7()
        @State private var lines: [Line7] = []
        @State private var deletedLines = [Line7]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Line7(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationa7_Previews: PreviewProvider {
