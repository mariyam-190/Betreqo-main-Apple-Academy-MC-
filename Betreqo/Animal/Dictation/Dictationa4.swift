...
//
    ...
    struct Dictationa4: View {
        @State private var currentLine = Line4()
        @State private var lines: [Line4] = []
        @State private var deletedLines = [Line4]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Line4(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationa4_Previews: PreviewProvider {
