...
//  CGPoint: A structure that contains a point in a two-dimensional coordinate system.
    ...
    struct Dictationa1: View {
        @State private var currentLine = Line1()
        @State private var lines: [Line1] = []
        @State private var deletedLines = [Line1]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Line1(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationa1_Previews: PreviewProvider {
