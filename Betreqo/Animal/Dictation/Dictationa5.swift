...
//
    ...
    struct Dictationa5: View {
        @State private var currentLine = Line5()
        @State private var lines: [Line5] = []
        @State private var deletedLines = [Line5]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Line5(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationa5_Previews: PreviewProvider {
