...
import SwiftUI
    ...
    struct Dictations5: View {
        @State private var currentLine = Lines5()
        @State private var lines: [Lines5] = []
        @State private var deletedLines = [Lines5]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines5(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations5_Previews: PreviewProvider {
