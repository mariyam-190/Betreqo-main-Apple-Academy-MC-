...
import SwiftUI
    ...
    struct Dictations9: View {
        @State private var currentLine = Lines9()
        @State private var lines: [Lines9] = []
        @State private var deletedLines = [Lines9]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines9(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations9_Previews: PreviewProvider {
