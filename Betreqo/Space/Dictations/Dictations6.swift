...
import SwiftUI
    ...
    struct Dictations6: View {
        @State private var currentLine = Lines6()
        @State private var lines: [Lines6] = []
        @State private var deletedLines = [Lines6]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines6(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations6_Previews: PreviewProvider {
