...
import SwiftUI
    ...
    struct Dictations3: View {
        @State private var currentLine = Lines3()
        @State private var lines: [Lines3] = []
        @State private var deletedLines = [Lines3]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines3(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations3_Previews: PreviewProvider {
