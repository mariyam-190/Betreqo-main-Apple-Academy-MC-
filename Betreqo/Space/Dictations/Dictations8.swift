...
import SwiftUI
    ...
    struct Dictations8: View {
        @State private var currentLine = Lines8()
        @State private var lines: [Lines8 ] = []
        @State private var deletedLines = [Lines8 ]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines8(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations8_Previews: PreviewProvider {
