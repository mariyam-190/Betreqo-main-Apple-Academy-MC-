...
import SwiftUI
    ...
    struct Dictations4: View {
        @State private var currentLine = Lines4()
        @State private var lines: [Lines4] = []
        @State private var deletedLines = [Lines4]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines4(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations4_Previews: PreviewProvider {
