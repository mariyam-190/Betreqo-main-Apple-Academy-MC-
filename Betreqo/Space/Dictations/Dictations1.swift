...
import SwiftUI
    ...
    struct Dictations1: View {
        @State private var currentLine = Lines1()
        @State private var lines: [Lines1] = []
        @State private var deletedLines = [Lines1]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines1(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations1_Previews: PreviewProvider {
