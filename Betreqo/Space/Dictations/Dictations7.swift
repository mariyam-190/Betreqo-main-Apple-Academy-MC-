...
import SwiftUI
    ...
    struct Dictations7: View {
        @State private var currentLine = Lines7()
        @State private var lines: [Lines7] = []
        @State private var deletedLines = [Lines7]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines7(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations7_Previews: PreviewProvider {
