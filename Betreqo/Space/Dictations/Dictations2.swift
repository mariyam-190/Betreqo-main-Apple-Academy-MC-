...
//
    ...
    struct Dictations2: View {
        @State private var currentLine = Lines2()
        @State private var lines: [Lines2] = []
        @State private var deletedLines = [Lines2]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Lines2(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictations2_Previews: PreviewProvider {
