...
import SwiftUI
    ...
    struct Dictationp3: View {
        @State private var currentLine = Linep3()
        @State private var lines: [Linep3] = []
        @State private var deletedLines = [Linep3]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep3(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp3_Previews: PreviewProvider {
