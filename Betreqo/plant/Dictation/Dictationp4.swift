...
//
    ...
    struct Dictationp4: View {
        @State private var currentLine = Linep4()
        @State private var lines: [Linep4] = []
        @State private var deletedLines = [Linep4]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep4(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp4_Previews: PreviewProvider {
