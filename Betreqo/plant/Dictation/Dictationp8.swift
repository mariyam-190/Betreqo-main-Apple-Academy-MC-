...
import SwiftUI
    ...
    struct Dictationp8: View {
        @State private var currentLine = Linep8()
        @State private var lines: [Linep8 ] = []
        @State private var deletedLines = [Linep8 ]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep8(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp8_Previews: PreviewProvider {
