...
import SwiftUI
    ...
    struct Dictationp9: View {
        @State private var currentLine = Linep9()
        @State private var lines: [Linep9] = []
        @State private var deletedLines = [Linep9]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep9(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp9_Previews: PreviewProvider {
