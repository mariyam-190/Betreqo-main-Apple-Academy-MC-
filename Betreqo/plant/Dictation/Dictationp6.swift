...
import SwiftUI
    ...
    struct Dictationp6: View {
        @State private var currentLine = Linep6()
        @State private var lines: [Linep6] = []
        @State private var deletedLines = [Linep6]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep6(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp6_Previews: PreviewProvider {
