...
//
    ...
    struct Dictationp1: View {
        @State private var currentLine = Linep1()
        @State private var lines: [Linep1] = []
        @State private var deletedLines = [Linep1]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep1(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp1_Previews: PreviewProvider {
