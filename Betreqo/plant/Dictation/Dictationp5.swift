...
import SwiftUI
    ...
    struct Dictationp5: View {
        @State private var currentLine = Linep5()
        @State private var lines: [Linep5] = []
        @State private var deletedLines = [Linep5]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep5(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp5_Previews: PreviewProvider {
