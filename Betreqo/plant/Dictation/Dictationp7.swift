...
import SwiftUI
    ...
    struct Dictationp7: View {
        @State private var currentLine = Linep7()
        @State private var lines: [Linep7] = []
        @State private var deletedLines = [Linep7]()
                    ...
                    VStack
                    {
                        ...
                        Canvas { context, size in
                            ...
                            .onChanged({ value in
                                ...
                                .onEnded({ value in
                                    self.currentLine = Linep7(points: [], color: selectedColor, lineWidth: thickness)
                                })
                        )
    ...
    struct Dictationp7_Previews: PreviewProvider {
